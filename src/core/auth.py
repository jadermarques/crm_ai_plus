...
This module provides functions for user authentication, including credential
verification, user creation/update, and password management. Uses PBKDF2-SHA256
...
Functions:
    ensure_users_table: Create database table if not exists
